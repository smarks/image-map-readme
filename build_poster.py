...
def build_svg(content: dict, brain_height: int) -> str:
    ...
    # bottom row: about, quotes, links
    bottom_y = max(left_bottom, right_bottom, brain_y_bottom + 60) + 10
...
<svg viewBox="0 0 {CANVAS_WIDTH} {canvas_height}" width="{CANVAS_WIDTH}" height="{canvas_height}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <text x="2300" y="{brain_y_bottom+47}" text-anchor="middle" class="b" fill="#8A91A3" font-style="italic">{escape(content["brain_caption"])}</text>
  {hotspots}
